...
//        try{
//            Producto producto1 = new Producto("pizza meatLove", new BigDecimal(149.99), "piza con 3 tipos de carnes");
//            Producto producto2 = new Producto("pizza clasica", new BigDecimal(89.99), "pizza con peperoni");
//            Producto producto3 = new Producto("piza mexicana", new BigDecimal(119.99), "pizza con chorizo , jalapeño y viene con tortillas");
//            
